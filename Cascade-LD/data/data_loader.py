...
#                                 cfg.row_anchor, cfg.col_anchor, cfg.train_width, cfg.train_height, cfg.dataset, cfg.crop_ratio)
class TrainCollect:
    def __init__(self, batch_size, num_threads, data_root, list_path, train_width, train_height, dataset_name, top_crop = 0.0):
